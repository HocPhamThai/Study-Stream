  ...
  return (
    <div>
      ...
      <div className="w-[48px] h-screen flex flex-col items-center py-4 space-y-4 mx-auto ml-5">
            ...
            <Link to="/chat" onClick={() => handleClick('chat')}>
              ...
              >
                ...
                <path
                  ...
                  clipRule="evenodd"
                  fill={
                    selected === 'chat' ? 'url(#chatGradient)' : 'currentColor'
                  }
                />
              </svg>
            </Link>
        ...
        <span
          className="relative flex size-10 cursor-pointer items-center justify-center rounded-2xl p-2 md:size-[48px] hover:bg-orange-300 group"
