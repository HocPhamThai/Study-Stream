        ...
        <div className="flex-1 p-4 m-auto my-4 max-w-7xl rounded-lg bg-white px-6 py-4">
          <div className='mb-4 '>
            <div className='flex items-center gap-8'>
              ...
              <span className='ml-5 text-xl font-bold'>{topic?.nameOfTopic} workspace</span>
            </div>
            <div className='inline-flex w-full items-center h-full box-border pl-6 py-3 mt-2'>
              <svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="20" height="20" x="0" y="0" viewBox="0 0 24 24" class="text-[#36353A]"><g><path d="m21.71 20.29-2.83-2.82a9.52 9.52 0 1 0-1.41 1.41l2.82 2.83a1 1 0 0 0 1.42 0 1 1 0 0 0 0-1.42zM4 11.5a7.5 7.5 0 1 1 7.5 7.5A7.5 7.5 0 0 1 4 11.5z" data-name="12" fill="currentColor" opacity="1" data-original="currentColor"></path></g></svg>
              <input
                type="text"
