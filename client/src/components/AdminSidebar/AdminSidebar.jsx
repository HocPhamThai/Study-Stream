      ...
      <aside id="logo-sidebar" className="fixed top-0 left-0 z-40 w-64 h-full transition-transform -translate-x-full sm:translate-x-0" aria-label="Sidebar">
        <div className="h-full px-3 py-4 overflow-y-auto bg-gray-50">
          <div className="flex items-center justify-between">
            ...
            <p className="align-center text-black-600 font-bold text-xl">Study Stream</p>
          </div>
          <ul className="space-y-2 font-medium">
            <li>
              <Link to="/adminhome" className="flex items-center p-2 text-gray-900 rounded-lg hover:bg-gray-100">
            ...
            <li>
              <Link to="/admin-topic" className="flex items-center p-2 text-gray-900 rounded-lg hover:bg-gray-100 group">
            ...
            <li>
              <Link to="/admin-songs" className="flex items-center p-2 text-gray-900 rounded-lg hover:bg-gray-100 group">
            ...
            >
              ...
              <span className="flex-1 ms-3 whitespace-nowrap text-gray-900">Log out</span>
            </li>
          </ul>
        </div>
      </aside>
