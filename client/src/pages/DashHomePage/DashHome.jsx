    ...
    <div className="bg-gray-200 z-50 -m-4">
      ...
      <div className="flex justify-between items-center bg-transparent p-2">
        <div className="w-auto h-9 relative ml-5 flex items-center space-x-5">
          ...
          <img className='h-8 w-8' src='https://storageaccountstudy9794.blob.core.windows.net/badge/a6faf8b1-f7ca-4556-a202-dde9473163ce.svg' alt="" />
        </div>
      ...
      <div className="flex flex-col md:flex-row">
        ...
        <div className="flex-1 p-4 m-auto my-4 max-w-5xl rounded-2xl bg-white px-6 py-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-4 gap-4">
            <div className="p-8 w-full bg-white col-span-1 m-auto flex flex-col items-start gap-4 rounded-xl text-black shadow-md">
              <p className="text-medium font-semibold md:text-lg">✍️ Study room</p>
            ...
            <div className="p-8 w-full bg-white col-span-1 m-auto flex flex-col items-start gap-4 rounded-xl text-black shadow-md">
              <p className="text-medium font-semibold md:text-lg">🧑🏻‍💻 Working room</p>
            ...
            <div className="p-8 w-full bg-white col-span-1 m-auto flex flex-col items-start gap-4 rounded-xl text-black shadow-md">
              <p className="text-medium font-semibold md:text-lg">⏳ Quite room </p>
              <p className="mt-4 text-sm"> Your personal study haven for ultimate focus</p>
              <button className="button px-4 py-2 border rounded-xl" type="button">
                Join now
              </button>
            </div>
            <div className="p-8 w-full bg-white col-span-1 bg-gray-300 m-auto flex flex-col items-start gap-4 rounded-xl text-black shadow-md">
              <p className="text-medium font-semibold md:text-lg">💡 Creative room</p>
              <p className="mt-4 text-sm">Unleash your creativity, one study session at a time</p>
              <button className="button px-4 py-2 border rounded-xl" type="button">
                Join now
              </button>
            </div>
        ...
        {/* Right sidebar */}
        <div className="hidden md:block w-96 mr-5">
          <FavoritePlaylist />
