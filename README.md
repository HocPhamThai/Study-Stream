...
# ⏲ Study Stream
  *A modern React JS application with reusable components and Tailwind CSS for responsive design* 🚀
  ...
  ![ReactJS](https://img.shields.io/badge/React_JS-black?style=for-the-badge&logo=react&logoColor=61DAFB) ![TailwindCSS](https://img.shields.io/badge/Tailwind_CSS-black?style=for-the-badge&logo=tailwindcss&logoColor=62baf3) ![MongoDB](https://img.shields.io/badge/MongoDB-black?style=for-the-badge&logo=mongodb&logoColor=00ED64) ![Expressjs](https://img.shields.io/badge/express-black?style=for-the-badge&logo=express&logoColor=00000) ![Vercel](https://img.shields.io/badge/vercel-black?style=for-the-badge&logo=vercel&logoColor=00000)

  <img width="595px" src="https://res.cloudinary.com/diskkx82m/image/upload/v1728019128/home_kovcta.png">

  [![Live Demo](https://img.shields.io/badge/🔗_Visit_website-white?style=flat)](https://study-stream-fe.vercel.app)
</div>
...
*Welcome to Study Stream, the project of my thesis.  Study Stream is a website that helps learners manage their time and boosts motivation through the Pomodoro Technique. This website has a friendly user interface and is easy to use with both Vietnamese and English.*

## 💻 <a name="technologies">Technologies</a>

<div align="center">

  ![Technologies](https://skillicons.dev/icons?i=mongo,express,react,nodejs,tailwind,mui,vercel)

</div>

- **MongoDB:** For storing and retrieving data in a NoSQL database.
- **ExpressJS:** For handling the backend logic and managing routes.
- **ReactJS:** For building user interfaces with reusable components.
- **NodeJS:** For building user interfaces with reusable components.
- **MUI (Material-UI):** For providing pre-built React components and customizable styles.
- **Vercel** For deploying and hosting the full-stack application with serverless functions.
...
### Nguyen Tan Luc
- **Portfolio:** [tanluc.click](https://tanluc.click/)
- **LinkedIn:** [tanlucdev](https://www.linkedin.com/in/tanlucdev/)
